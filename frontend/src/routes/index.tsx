...
function Index() {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* Govt Banner */}
      <div className="w-full h-full bg-gradient-to-r  from-primary/5 via-primary/10 to-primary/5 border-b border-primary/10">
        <div className="mx-auto  ">
          <img
            src={bannerImage}
            alt="Government of India"
            className="w-full lg:h-60 lg:hidden object-fill md:h-20"
          />
        </div>
      </div>
      ...
      <AnimatedSection>
        <section className="relative overflow-hidden">
          ...
          <div className="mx-auto max-w-7xl px-4 py-10 sm:px-6 sm:py-20 lg:px-8 lg:py-10">
            <div className="grid items-center gap-12 lg:grid-cols-2">
              ...
              >
                ...
                <div className="mt-8 flex flex-wrap gap-3">
                  <Button asChild size="lg" className="bg-primary px-8 text-primary-foreground shadow-lg shadow-primary/25 hover:bg-primary/90">
                    <Link to="/register">Register</Link>
                  </Button>
                  <Button asChild variant="outline" size="lg" className="border-border px-8 hover:bg-accent">
          ...
          <AnimatedGrid className="grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
            {metrics.map((metric) => (
              <AnimatedItem key={metric.label}>
                <div className="group relative overflow-hidden rounded-2xl border border-border bg-card p-6 shadow-card transition-all duration-300 hover:shadow-card-hover">
          ...
          <AnimatedGrid className="mt-12 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {features.map((feature) => (
              <AnimatedItem key={feature.title}>
                <div className="group rounded-2xl border border-border bg-card p-8 shadow-card transition-all duration-300 hover:-translate-y-1 hover:shadow-card-hover">
      ...
      <AnimatedSection delay={0.1}>
        <section className="relative mx-auto max-w-7xl px-4 py-14 pb-20 sm:px-6 lg:px-8">
          ...
          <AnimatedGrid className="mt-12 grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
