...
import { B as Button, l as logoSrc } from "./logo-CI0y-aPP.mjs";
import { b as AnimatedSection, A as AnimatedGrid, a as AnimatedItem } from "./router-CtIKCGl9.mjs";
import "../_libs/sonner.mjs";
import { m as motion } from "../_libs/framer-motion.mjs";
import { n as Shield, F as FileText, f as CircleCheck, m as ChartColumn, o as Users, h as Search, Z as Zap, p as Send, k as Building2, q as Briefcase, M as Mail, i as Phone, j as MapPin } from "../_libs/lucide-react.mjs";
...
function Navbar() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("header", { className: "sticky top-0 z-50 w-full border-b border-border bg-background/80 backdrop-blur-md", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/", className: "flex items-center gap-2.5 transition-opacity hover:opacity-80", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex h-9 w-9 items-center justify-center rounded-lg", children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: logoSrc, alt: "Citizen Connect", className: "h-9 w-9" }) }),
...
const heroIllustration = "/assets/hero-illustration-DIcnkmgg.png";
